//
//  VOSCoreDataCollectionViewController.m
//  CoreDataTest
//
...
@interface VOSCoreDataCollectionViewController ()<NSFetchedResultsControllerDelegate>
@property (strong, nonatomic) NSMutableArray *objectChanges;
@property (strong, nonatomic) NSMutableArray *sectionChanges;

@end

@implementation VOSCoreDataCollectionViewController
...
-(void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    NSAssert(self.detailViewControllerClassName, @"You must register a detailViewController Protocol!");

    // Obtenemos el modelo
    id detailModel = [self.fetchedResultsController objectAtIndexPath:indexPath];
    
    // Creamos el controlador de detalle
    UIViewController <VOSDetailViewController> *detailVC = [[NSClassFromString(self.detailViewControllerClassName) alloc] initWithModel:detailModel];
